                        ...
                        if (data.Data[0].Childs != null && data.Data[0].Childs.length > 0) {
                           // bt += '<div class="child_ct">';
                            $.each(data.Data[0].Childs, function (ii, citem) { 
                                bt += '<button class="btn col-md-4 image-' + ii + '" name="dg_' + data.Data[0].Id + '" onclick="DanhGia(\'' + data.Data[0].Id + '_' + citem.Id + '\')"  value="' + citem.Id + '" > <span class="button-text">' + citem.Name + '</span></button>';
                            });
