...
GPRO.BenhVien = function () {
    ...
    function SaveConfig() {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: JSON.stringify({ 'configStr': str, 'pageType': 6 }),
    ...
    function Get() {
        $.ajax({
            ...
            success: function (data) {
                ...
                //if (Global.Data.first && Global.Data.reading) {
                //    Global.Data.reading = false;
                //    Global.Data.first = false;
                //}
    ...
    function initAudio() {
        var audioE = document.getElementById('myAudio');
    ...
    function GetConfig() {
        $.ajax({
            ...
            type: 'POST',
            data: JSON.stringify({ 'pageType': '6' }),
            contentType: 'application/json charset=utf-8',
            success: function (data) {
