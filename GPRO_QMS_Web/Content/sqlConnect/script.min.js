...
//!function(t,d,e,i,n){(n=d.body).insertAdjacentHTML("beforeend",'<div data-formito-id="efk3xf6OHZAtUfyYtv6l" data-trigger="fab" data-button-icon="https://s.formito.com/img/icon-fab/1.png"></div>'),(i=d.createElement("script")).async=!0,i.src="https://s.formito.com/ft.js",n.appendChild(i)}(window,document);
